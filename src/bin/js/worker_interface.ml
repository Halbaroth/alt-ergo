  ...
  union
    [
      case (Tag 1) ~title:"Tableaux" (constant "Tableaux")
        ...
        (fun () -> Tableaux);
      case (Tag 2) ~title:"Tableaux_CDCL" (constant "Tableaux_CDCL")
        (function Tableaux_CDCL -> Some () | _ -> None)
        (fun () -> Tableaux_CDCL);
      case (Tag 3) ~title:"CDCL" (constant "CDCL")
        (function CDCL -> Some () | _ -> None)
        (fun () -> CDCL);
      case (Tag 4) ~title:"CDCL_Tableaux" (constant "CDCL_Tableaux")
        (function CDCL_Tableaux -> Some () | _ -> None)
        (fun () -> CDCL_Tableaux);
    ]

type frontend = Legacy | Unknown of string

let frontend_encoding =
  union
    [
      case (Tag 1) ~title:"Legacy" (constant "Legacy")
        (function Legacy -> Some () | _ -> None)
        (fun () -> Legacy);
      case (Tag 2) ~title:"Unknown"
        (obj1 (req "Unknown" string))
        (function Unknown s -> Some s | _ -> None)
        (fun s -> Unknown s);
    ]
...
let opt_dbg2_encoding =
  conv
    (fun dbg2 -> dbg2)
    (fun dbg2 -> dbg2)
    (obj10 (opt "debug_fm" bool) (opt "debug_fpa" int31) (opt "debug_gc" bool)
       (opt "debug_interpretation" bool)
       (opt "debug_ite" bool)
       (opt "debug_matching" int31)
       (opt "debug_sat" bool) (opt "debug_split" bool) (opt "debug_sum" bool)
...
let opt_dbg3_encoding =
  conv
    (fun dbg3 -> dbg3)
    (fun dbg3 -> dbg3)
    (obj6 (opt "debug_types" bool) (opt "debug_typing" bool)
       (opt "debug_uf" bool)
...
let opt6_encoding =
  conv
    ...
    (obj10
       ...
       (opt "tableaux_cdcl" bool) (opt "disable_ites" bool)
       (opt "inline_lets" bool) (opt "rewriting" bool) (opt "term_like_pp" bool)
       (opt "disable_adts" bool) (opt "no_ac" bool))
...
let opt7_encoding =
  conv
    ...
    (obj10
       ...
       (opt "use_fpa" bool) (opt "timers" bool) (opt "file" string))
