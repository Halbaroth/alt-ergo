...
type t
type decl_kind = Dtheory | Daxiom | Dgoal | Dpredicate of t | Dfunction of t
...
type term_view = private Term of view | Not_a_term of { is_lit : bool }
...
val make_triggers :
  t -> binders -> decl_kind -> Util.Util.matching_env -> trigger list
...
val mk_exists :
  ...
  (* id, for the GUI *)
  toplevel:bool ->
  (* for future triggers computation in presence of
