...
and 'a tt_desc =
  ...
  | TTvar of Sy.t  (** Term variables *)
  | TTinfix of 'a atterm * Sy.t * 'a atterm  (** Infix symbol application *)
...
val print_rwt :
  (Format.formatter -> 'a -> unit) -> Format.formatter -> 'a rwt_rule -> unit
