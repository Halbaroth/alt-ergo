...
let assume env uf sa =
  ...
  let env1, { assume = a1; remove = rm1 } = Rel1.assume env.r1 uf sa in
  let env2, { assume = a2; remove = rm2 } = Rel2.assume env.r2 uf sa in
  let env3, { assume = a3; remove = rm3 } = Rel3.assume env.r3 uf sa in
  let env4, { assume = a4; remove = rm4 } = Rel4.assume env.r4 uf sa in
  let env5, { assume = a5; remove = rm5 } = Rel5.assume env.r5 uf sa in
...
let add env uf r t =
  ...
  ( { r1; r2; r3; r4; r5; r6; r7 },
    eqs1 |@| eqs2 |@| eqs3 |@| eqs4 |@| eqs5 |@| eqs6 |@| eqs7 )
...
let instantiate ~do_syntactic_matching t_match env uf selector =
  ...
  in
  let r7, l7 =
    Rel7.instantiate ~do_syntactic_matching t_match env.r7 uf selector
  in
  ({ r1; r2; r3; r4; r5; r6; r7 }, l7 |@| l6 |@| l5 |@| l4 |@| l3 |@| l2 |@| l1)
